...
Como o sistema diferencia permissões por perfil, o primeiro Administrador deve ser criado via requisição direta (Ex: Postman, Insomnia ou cURL) para o endpoint de cadastro, enviando explicitamente a role ADMIN:

  

Endpoint: POST /auth/register (ou conforme sua rota de cadastro)
